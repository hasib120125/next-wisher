...
{
    private $token = "eyJraWQiOiIxIiwiYWxnIjoiSFMyNTYifQ.eyJqdGkiOiI1MjFjOGY0My1hNDFlLTQ3MGItODIzMC0wZmExZmNmMzg0ZDIiLCJzdWIiOiIyODUiLCJpYXQiOjE3MDAwMjg4MjAsImV4cCI6MjAxNTY0ODAyMCwicG0iOiJEQUYsUEFGIiwidHQiOiJBQVQifQ.m5GVNY5obrdzCFZcIIxcjs3m2uJBLtbtVObN1ntwtKQ";
    ...
    public function createPayment(Request $request, $id)
    {
        ...
        // $mno = $request->mobile_payload['mno'] ?? "MTN";
        // $conversion_rate
    ...
    public function mobile_pay_callback(Request $request)
    {
        ...
        $response = json_decode($this->getDepositStatus($request->depositId));
