                          ...
                          <tr>
                            <td class="v-container-padding-padding" style="overflow-wrap:break-word;word-break:break-word;padding:50px 50px 0px;font-family:'Open Sans',sans-serif;" align="left">
                              ...
                              <h1 class="v-text-align v-line-height v-font-size" style="margin: 0px; line-height: 140%; text-align: left; word-wrap: break-word; font-size: 24px; ">
                                ...
                                @endphp
                                <div>
                                  <span style="font-weight: normal;">Name: </span> <strong>{{ $contact->name }}</strong>
                                </div>
                                <div>
                                  <span style="font-weight: normal;">Email: </span> <strong>{{ $contact->email }}</strong>
                                </div>
                                <div>
                                  <span style="font-weight: normal;">Subject: </span> <strong>{{ $contact->subject }}</strong>
                                </div>
                                <div>
                                  <span style="font-weight: normal;">Reason: </span> <strong>{{ $contact->reason }}</strong>
                                </div>
                              </h1>
