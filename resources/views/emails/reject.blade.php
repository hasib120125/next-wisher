                          ...
                          <tr>
                            <td class="v-container-padding-padding" style="overflow-wrap:break-word;word-break:break-word;padding:50px 50px 0px;font-family:'Open Sans',sans-serif;" align="left">
                              ...
                              <h1 class="v-text-align v-line-height v-font-size" style="margin: 0px; line-height: 140%; text-align: left; word-wrap: break-word; font-size: 24px; ">
                                <span style="font-weight: normal;">Hi</span> <strong>,</strong>
                              </h1>
                              ...
                              <div class="v-text-align v-line-height v-font-size" style="line-height: 170%; text-align: justify; word-wrap: break-word;">
                                <p style="line-height: 170%;text-align: center;">
                                    ...
                                    <ul style="list-style-type: none;text-align: center;">
                                        <li>We were not able to approve your account for some reason.</li>
                                        <li>Please contact us at support@nextwisher.com</li>
                                    </ul>
                                </p>
                                {{-- <p style="line-height: 170%;text-align: center;">
                                    Feel free to resubmit a new application with the correct information.
                                </p> --}}
                              </div>
