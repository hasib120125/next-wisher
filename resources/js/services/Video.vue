<template>
    <div v-if="src" @click.self="handleVideoPlayToggle" class="cursor-pointer relative h-full group bg-black">
        ...
        <video
            ...
            class="w-full absolute bottom-0 pointer-events-none h-full"
            :class="!videoPlayToggle ? 'object-cover' : ''"
            :muted="isMuted"
        ...
        <button 
            ...
            class="w-10 h-10 bg-white shadow flex z-10 items-center justify-center rounded-full absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2"
        >
